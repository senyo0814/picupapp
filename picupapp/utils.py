...
def add_watermark(image_file, username):
    try:
        # ✅ Fix orientation using EXIF before processing
        img = Image.open(image_file)
        img = ImageOps.exif_transpose(img)
        base = img.convert("RGBA")
    except Exception as e:
        print(f"[ERROR] Failed to open or transpose image: {e}")
        return None
    ...
    # ✅ Transparent layer for watermark text
    ...
    # ✅ Combine layers and return file
